...
const LANE_REGISTRY_V0 = [
  {
    ...
    launch_ready: true,
    parallel_slot: 1,
    note: "Station 1 JOA worker loop — JuOS runtime lane in TimOS-Agent repo (slot 1 in use)",
  },
  {
    room: "NovaBridge (NB)",
    ...
    launch_ready: false,
    parallel_slot: 2,
    note: "Nova workspace — smoke test + nova hub before first job",
  },
  {
    room: "Finance / JFA",
    source_room: "JFA",
  ...
  },
  {
    room: "STUF",
    source_room: "STUF",
    active_lane: "stuf-dev",
    profile: "stuf",
    lane_status: "ready_to_test",
    readiness_category: "Ready to test",
    launch_ready: false,
    parallel_slot: null,
    note: "STUF-Website workspace — dedicated stuf hub; not JOA or spacea bridge",
  },
  {
    room: "SpaceA",
    source_room: "SpaceA",
    ...
    launch_ready: false,
    parallel_slot: null,
    note: "Kenkoup, Primoo, _ClientOps; per-job repo_ref and workspace_ref; spacea hub required",
  },
  {
    room: "MinistryOps",
