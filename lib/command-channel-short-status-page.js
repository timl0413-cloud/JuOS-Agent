...
function renderCurrentQueueBlock(currentQueue, isLive) {
  ...
  return `<section class="batch-section batch-section-primary">
    ...
    ${reviewHistoryNote}
    ${batchTable}
    <p class="batch-legend muted">Row colors: grey = Done · vivid green = Running/Ongoing (live claimed job only) · yellow = Waiting / Needs Tim / Awaiting approval · red = Failed · blue = Next / Queued / Not started · “· live” = matched command-channel job · “· planned” = no live job yet — static until linked</p>
  </section>`;
}
